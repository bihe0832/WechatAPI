...
$menu = array ("button" => array (0 => array ("name" => urlencode ( "菜单一" ), "sub_button" => array (0 => array ("type" => "view", "name" => urlencode ( "常见问题" ), "url" => "http://bihe0832.sinaapp.com" ), 1 => array ("type" => "click", "name" => urlencode ( "使用指南" ), "key" => "V003_HELP" ) ) ), 1 => array ("type" => "click", "name" => urlencode ( "菜单二" ), "key" => "V002_MORENOTE" ), 2 => array ("name" => urlencode ( "菜单三" ), "sub_button" => array (0 => array ("type" => "click", "name" => urlencode ( "我要提问" ), "key" => "V003_ASK" ), 1 => array ("type" => "click", "name" => urlencode ( "意见反馈" ), "key" => "V003_ADVICE" ) ) ) ) );
$method = $_GET ["a"];
echo "Help:<BR>";
